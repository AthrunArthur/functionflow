...
{
    string in_file_name = "../../benchmark/quick_sort/numbers.txt";
    string out_file_name = "../../benchmark/quick_sort/numbers_sort.txt";
...
//         cout << data[i] << tmp;
    ...
    len = i;
    para_len = len / n_div;
//     cout << "len = " << len << " Para len = " << para_len << endl;
    in_file.close();
